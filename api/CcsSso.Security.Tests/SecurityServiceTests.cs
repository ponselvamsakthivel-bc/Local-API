  ...
  public class SecurityServiceTests
  {
    ...
    public class GetRenewedToken
    {
      ...
      public async Task ThrowsException_WhenPassEmptyRefreshToken()
      {
        ...
        await Assert.ThrowsAsync<CcsSsoException>(async () => await service.GetRenewedTokenAsync(tokenRequest));
      }
      ...
      public async Task ReturnsToken_WhenPassValidRefreshToken()
      {
        ...
        var result = await service.GetRenewedTokenAsync(tokenRequest);
