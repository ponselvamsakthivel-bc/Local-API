...
namespace CcsSso.Service
{
  public class ContactService : IContactService
  {
    ...
    private async Task<int> CreateOrganisationContactAsync(ContactDetailDto contactDetailsDto)
    {
      ...
      var organisation = await _dataContext.Organisation.FirstOrDefaultAsync(o => o.Id == contactDetailsDto.OrganisationId);
    ...
    private async Task<int> CreateOrganisationPersonContactAsync(ContactDetailDto contactDetailsDto)
    {
      ...
      var partyTypeId = (await _dataContext.PartyType.FirstOrDefaultAsync(t => t.PartyTypeName == "NON_USER")).Id;
      var contactPointReasonId = await GetContactPointReasonIdAsync(contactDetailsDto.ContactReason);
    ...
    {
      var reasonString = string.IsNullOrEmpty(reason) ? "OTHER" : reason.ToUpper();
      ...
      return contactReasons.FirstOrDefault(r => r.Name == "OTHER").Id;
    }
    ...
    {
      //if (isCreation && contactDetailModel.ContactType == ContactType.OrganisationPerson && contactDetailModel.OrganisationId == 0)
      //{
      //  throw new CcsSsoException(ErrorConstant.ErrorOrganisationIdRequired);
      //}

      //if (contactDetailModel.ContactType == ContactType.OrganisationPerson && string.IsNullOrEmpty(contactDetailModel.Name))
      //{
      //  throw new CcsSsoException(ErrorConstant.ErrorNameRequired);
      //}

      //if (contactDetailModel.ContactType == ContactType.OrganisationPerson && string.IsNullOrEmpty(contactDetailModel.Email))
      //{
      //  throw new CcsSsoException(ErrorConstant.ErrorEmailRequired);
      //}

      //if (contactDetailModel.ContactType == ContactType.OrganisationPerson && !UtilitiesHelper.IsEmailValid(contactDetailModel.Email))
      //{
      //  throw new CcsSsoException(ErrorConstant.ErrorInvalidEmailFormat);
      //}

      //if (contactDetailModel.ContactType == ContactType.OrganisationPerson && string.IsNullOrEmpty(contactDetailModel.PhoneNumber))
      //{
      //  throw new CcsSsoException(ErrorConstant.ErrorPhoneNumberRequired);
      //}

      //if (isCreation && contactDetailModel.ContactType == ContactType.Organisation && contactDetailModel.PartyId == 0)
      //{
      //  throw new CcsSsoException(ErrorConstant.ErrorPartyIdRequired);
      //}

      //if (contactDetailModel.ContactType == ContactType.Organisation && contactDetailModel.Address == null)
      //{
      //  throw new CcsSsoException(ErrorConstant.ErrorAddressRequired);
      //}
    }
