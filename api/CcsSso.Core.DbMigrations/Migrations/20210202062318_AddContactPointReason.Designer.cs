...
namespace CcsSso.DbMigrations.Migrations
{
    ...
    [Migration("20210202062318_AddContactPointReason")]
    partial class AddContactPointReason
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CcsSso.DbModel.Entity.OrganisationAccessRole", b =>
                {
                    ...
                    b.HasKey("OrganisationAccessRoleId");
            ...
            modelBuilder.Entity("CcsSso.DbModel.Entity.OrganisationEnterpriseType", b =>
                {
                    b.Property<int>("OrganisationEnterpriseTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .UseIdentityByDefaultColumn();
                    ...
                    b.HasKey("OrganisationEnterpriseTypeId");
            ...
            modelBuilder.Entity("CcsSso.DbModel.Entity.TradingOrganisation", b =>
                {
                    b.Property<int>("TradingOrganisationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .UseIdentityByDefaultColumn();
                    ...
                    b.HasKey("TradingOrganisationId");
            ...
            modelBuilder.Entity("CcsSso.DbModel.Entity.User", b =>
                {
                    ...
                    b.Property<int?>("IdentityProviderIdpId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdentityProviderIdpId");
            ...
            modelBuilder.Entity("CcsSso.DbModel.Entity.UserGroupMembership", b =>
                {
                    b.Property<int>("UserGroupMembershipId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .UseIdentityByDefaultColumn();
                    ...
                    b.HasKey("UserGroupMembershipId");
            ...
            modelBuilder.Entity("CcsSso.DbModel.Entity.ContactDetail", b =>
                {
                    b.HasOne("CcsSso.DbModel.Entity.ContactPoint", "ContactPoint")
                        ...
                        .HasForeignKey("CcsSso.DbModel.Entity.ContactDetail", "ContactPointId")
            ...
            modelBuilder.Entity("CcsSso.DbModel.Entity.User", b =>
                {
                    b.HasOne("CcsSso.DbModel.Entity.IdentityProvider", "IdentityProvider")
                        .WithMany("Users")
                        .HasForeignKey("IdentityProviderIdpId");
