    ...
    public class CreateUser
    {
      public static IEnumerable<object[]> CorrectUserData =>
            new List<object[]>
            {
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "newuser@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }, new List<int> {1})
                },
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP ", " UserLN1UP", "newuser@mail.com", "CiiOrg1", 2, UserTitle.Doctor, new List<int> {1, 2 })
                },
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo(" UserFN1UP ", " UserLN1UP ", "newuser@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 })
                }
            };
      ...
      public async Task CreateUser_WhenCorrectInfo(UserProfileEditRequestInfo userRequestInfo)
      {
        await DataContextHelper.ScopeAsync(async dataContext =>
        {
          ...
          Assert.Equal(userRequestInfo.Detail.IdentityProviderId == 1, result.IsRegisteredInIdam);
          ...
          Assert.Equal(userRequestInfo.Detail.IdentityProviderId, createdUser.OrganisationEligibleIdentityProviderId);
          ...
          if (userRequestInfo.Detail.IdentityProviderId == 1)
          {
      ...
      public static IEnumerable<object[]> InCorrectUserData =>
            new List<object[]>
            {
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("", "UserLN1UP", "usernew@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  ErrorConstant.ErrorInvalidFirstName
                },
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "", "usernew@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  ErrorConstant.ErrorInvalidLastName
                },
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo(null, "UserLN1UP", "usernew@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  ErrorConstant.ErrorInvalidFirstName
                },
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", null, "usernew@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  ErrorConstant.ErrorInvalidLastName
                },
                new object[]
                {
                ...
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "usernew@mail.com", "CiiOrg1", 0, UserTitle.Doctor, new List<int> {1, 2 }),
                ...
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "usernew@mail.com", "CiiOrg1", 1, UserTitle.Doctor, null, new List<int> {0, 1, 2 }),
                  ErrorConstant.ErrorInvalidUserRole
                },
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "usernew@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {0, 1, 2 }),
                  ErrorConstant.ErrorInvalidUserGroup
                },
                new object[]
                {
      ...
      public static IEnumerable<object[]> NonExistingOrgForUserData =>
            new List<object[]>
            {
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("UserFN2UP", "UserLN2UP", "usernew@mail.com", "WrongOrgId", 1, UserTitle.Doctor, new List<int> {1, 2 })
                }
            };
      ...
      public static IEnumerable<object[]> AlreadyExistingUserData =>
            new List<object[]>
            {
                new object[]
                {
                  DtoHelper.GetUserProfileRequestInfo("UserFN2UP", "UserLN2UP", "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 })
                }
            };
    ...
    public class UpdateUser
    {
      public static IEnumerable<object[]> CorrectMyAccountData =>
            new List<object[]>
            {
                ...
                {
                  "user1@mail.com", 1,
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "user1@mail.com", "CiiOrg1", 1, null, null, null)
                },
                new object[]
                {
                  "user2@mail.com", 2,
                  DtoHelper.GetUserProfileRequestInfo("UserFN2UP", "UserLN2UP", "user2@mail.com", "CiiOrg1", 1, null, null, null)
                },
                new object[]
                {
                  "user1@mail.com", 1,
      ...
      public static IEnumerable<object[]> CorrectUserData =>
            new List<object[]>
            {
                ...
                {
                  "user1@mail.com",
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  false, false
                },
                new object[]
                {
                  "user2@mail.com",
                  DtoHelper.GetUserProfileRequestInfo("UserFN2UP", "UserLN2UP", "user2@mail.com",  "CiiOrg1", 2, UserTitle.Doctor, new List<int> {1, 2 }),
                  false, false
                },
                new object[]
                {
                  "user1@mail.com",
                  DtoHelper.GetUserProfileRequestInfo(" UserFN1UP", "UserLN1UP ", "user1@mail.com", "CiiOrg1", 2, UserTitle.Doctor, new List<int> {1, 2 }),
                  false, true
                },
                new object[]
                {
                  "user2@mail.com",
                  DtoHelper.GetUserProfileRequestInfo(" UserFN2UP ", "  UserLN2UP ", "user2@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  true, false
                },
                new object[]
                {
                  "user1@mail.com",
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, null, new List<int> {1, 2 }),
                  false, false
                },
                new object[]
                {
                  "user1@mail.com",
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }, null),
                  false, false
                },
            };
      ...
      public async Task UpdateUser_WhenCorrectInfo(string userName, UserProfileEditRequestInfo userRequestInfo, bool isRegisteredInIdam, bool isDeletedFromIdam)
      {
        await DataContextHelper.ScopeAsync(async dataContext =>
        {
          ...
          .Include(u => u.Party).ThenInclude(p => p.Person)
          .Include(u => u.OrganisationEligibleIdentityProvider)
          .FirstOrDefaultAsync(u => !u.IsDeleted && u.UserName == userName);

          Assert.NotNull(updatedUser);
          Assert.Equal(userRequestInfo.FirstName.Trim(), updatedUser.Party.Person.FirstName);
          Assert.Equal(userRequestInfo.LastName.Trim(), updatedUser.Party.Person.LastName);
          Assert.Equal(userRequestInfo.Detail.IdentityProviderId, updatedUser.OrganisationEligibleIdentityProviderId);
      ...
      public static IEnumerable<object[]> InCorrectUserData =>
            new List<object[]>
            {
                ...
                {
                  "user1@mail.com", 1,
                  DtoHelper.GetUserProfileRequestInfo("", "UserLN1UP", "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  true, ErrorConstant.ErrorInvalidFirstName
                },
                new object[]
                {
                  "user1@mail.com", 1,
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "", "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  true, ErrorConstant.ErrorInvalidLastName
                },
                new object[]
                {
                  "user1@mail.com", 1,
                  DtoHelper.GetUserProfileRequestInfo(null, "UserLN1UP", "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  true, ErrorConstant.ErrorInvalidFirstName
                },
                new object[]
                {
                  "user1@mail.com", 1,
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", null, "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 }),
                  true, ErrorConstant.ErrorInvalidLastName
                },
                new object[]
                {
                ...
                {
                  "user1@mail.com", 1,
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "user1@mail.com", "CiiOrg1", 0, UserTitle.Doctor, new List<int> {1, 2 }),
                ...
                {
                  "user1@mail.com", 1,
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, null, new List<int> {0, 1, 2 }),
      ...
      public static IEnumerable<object[]> RemoveAdminGroupUserData =>
           new List<object[]>
           {
                ...
                {
                  "user1@mail.com",
                  DtoHelper.GetUserProfileRequestInfo("UserFN1UP", "UserLN1UP", "user1@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> { 2 })
                },
           };
      ...
      public static IEnumerable<object[]> NonExistingUserData =>
            new List<object[]>
            {
                new object[]
                {
                  ...
                  DtoHelper.GetUserProfileRequestInfo("UserFN2UP", "UserLN2UP", "usernotfound@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 })
                },
                new object[]
                {
                  "user4@mail.com",
                  DtoHelper.GetUserProfileRequestInfo("UserFN2UP", "UserLN2UP", "user4@mail.com", "CiiOrg1", 1, UserTitle.Doctor, new List<int> {1, 2 })
                },
            };
