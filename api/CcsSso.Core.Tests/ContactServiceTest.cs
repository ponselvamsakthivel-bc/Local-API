...
namespace CcsSso.Tests
{
  public class ContactServiceTest
  {
    public class Create
    {
      ...
      public static IEnumerable<object[]> InCorrectContactData =>
            new List<object[]>
            {
                new object[]
                {
                    DtoHelper.GetContactDetailDto(0, 0, 0, ContactType.OrganisationPerson, "FirstName LastName", "user@email.com", "0112345"),
                    ErrorConstant.ErrorOrganisationIdRequired
                },
                new object[]
                {
                    DtoHelper.GetContactDetailDto(0, 0, 2, ContactType.OrganisationPerson, string.Empty, "user@email.com", "0112345"),
                    ErrorConstant.ErrorNameRequired
                },
                new object[]
                {
                    DtoHelper.GetContactDetailDto(0, 0, 2, ContactType.OrganisationPerson, "FirstName LastName", string.Empty, "0112345"),
                    ErrorConstant.ErrorEmailRequired
                },
                new object[]
                {
                ...
                new object[]
                {
                    DtoHelper.GetContactDetailDto(0, 0, 2, ContactType.OrganisationPerson, "FirstName LastName", "user@email.com", string.Empty),
                    ErrorConstant.ErrorPhoneNumberRequired
                },
                new object[]
                {
                    DtoHelper.GetContactDetailDto(0, 0, 0, ContactType.Organisation, "FirstName LastName", "user@email.com", "0112345"),
                    ErrorConstant.ErrorPartyIdRequired
                },
                new object[]
                {
                    DtoHelper.GetContactDetailDto(0, 1, 2, ContactType.Organisation, string.Empty, "user@email.com", "0112345"),
                    ErrorConstant.ErrorAddressRequired
                },
            };
    ...
    public class Update
    {
      ...
      public static IEnumerable<object[]> InCorrectContactData =>
            new List<object[]>
            {
                new object[]
                {
                    DtoHelper.GetContactDetailDto(1, 1, 1, ContactType.OrganisationPerson, string.Empty, "user@email.com", "0112345"),
                    ErrorConstant.ErrorNameRequired
                },
                new object[]
                {
                    DtoHelper.GetContactDetailDto(1, 1, 1, ContactType.OrganisationPerson, "FirstName LastName", string.Empty, "0112345"),
                    ErrorConstant.ErrorEmailRequired
                },
                new object[]
                {
                ...
                new object[]
                {
                    DtoHelper.GetContactDetailDto(1, 1, 1, ContactType.OrganisationPerson, "FirstName LastName", "user@email.com", string.Empty),
                    ErrorConstant.ErrorPhoneNumberRequired
                }
            };
    ...
    public static async Task SetupTestDataAsync(IDataContext dataContext)
    {
      ...
      dataContext.ContactPoint.Add(new ContactPoint { Id = 1, PartyId = 3, ContactPointReasonId = 1, ContactDetailId = 1 });
      ...
      dataContext.ContactPoint.Add(new ContactPoint { Id = 2, PartyId = 4, ContactPointReasonId = 1, ContactDetailId = 2, IsDeleted = true });
