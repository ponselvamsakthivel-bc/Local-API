...
namespace CcsSso.Tests
{
  public class UserServiceTests
  {
    ...
    public static async Task SetupTestDataAsync(IDataContext dataContext)
    {
      ...
      dataContext.UserGroup.Add(new UserGroup { UserGroupName = "ADMIN", Id = 1, OrganisationId = 1 });
      ...
      dataContext.UserGroupMembership.Add(new UserGroupMembership { Id = 1, UserId = 1, UserGroupId = 1, MembershipStartDate = new DateTime() });
