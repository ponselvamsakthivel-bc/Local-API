...
namespace CcsSso.Security.Services
{
  public class SecurityService : ISecurityService
  {
    ...
    public async Task<TokenResponseInfo> GetRenewedTokenAsync(TokenRequestInfo tokenRequestInfo)
    {
    ...
    public async Task<string> LogoutAsync(string userName)
    {
      ...
      return await _identityProviderService.SignOutAsync(userName);
    }

    public async Task<string> GetAuthenticationEndPointAsync(string callbackUrl)
    {
      return await _identityProviderService.GetAuthenticationEndPointAsync(callbackUrl);
    }
